...
<h2><?php  echo __('Orderstatus'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($orderstatus['Orderstatus']['title']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Statuscode'); ?></dt>
		<dd>
			<?php echo h($orderstatus['Orderstatus']['statuscode']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Orderstatus'), array('action' => 'edit', $orderstatus['Orderstatus']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Orderstatus'), array('action' => 'delete', $orderstatus['Orderstatus']['id']), null, __('Are you sure you want to delete # %s?', $orderstatus['Orderstatus']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Orderstatuses'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Orderstatus'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($orderstatus['Roll'] as $roll): ?>
		<tr>
