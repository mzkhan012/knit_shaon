<div class="dyingstatuses view">
<h2><?php  echo __('Dyingstatus'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($dyingstatus['Dyingstatus']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Title'); ?></dt>
		<dd>
			<?php echo h($dyingstatus['Dyingstatus']['title']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Statuscode'); ?></dt>
		<dd>
			<?php echo h($dyingstatus['Dyingstatus']['statuscode']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Batchno'); ?></dt>
		<dd>
			<?php echo h($dyingstatus['Dyingstatus']['batchno']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Dyingstatus'), array('action' => 'edit', $dyingstatus['Dyingstatus']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Dyingstatus'), array('action' => 'delete', $dyingstatus['Dyingstatus']['id']), null, __('Are you sure you want to delete # %s?', $dyingstatus['Dyingstatus']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($dyingstatus['Roll'] as $roll): ?>
		<tr>
