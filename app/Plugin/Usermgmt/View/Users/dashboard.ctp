	...
	<div class="um_box_mid">
		<div class="um_box_mid_content">
			<div class="um_box_mid_content_top">
             ...
             <?php $user_gorup_id = $_SESSION['UserAuth']['UserGroup']['id']; ?>
		
	<?php if($user_gorup_id == 4) {?>
			<span  class="umstyle6"><?php echo $this->Html->link(__('Roll Add'), array('plugin' => false,'controller' => 'rolls', 'action' => 'add')); ?> </span><br/><br/>
			<?php }?>
            <?php if($user_gorup_id == 5) {?>
			<span  class="umstyle6"><?php echo $this->Html->link(__('Grey Store Manager'), array('plugin' => false,'controller' => 'rolls', 'action' => 'index')); ?> </span><br/><br/>
            <?php }?>
            <?php if($user_gorup_id == 6) {?>
			<span  class="umstyle6"><?php echo $this->Html->link(__('Dying Manager'), array('plugin' => false,'controller' => 'rolls', 'action' => 'index')); ?> </span><br/><br/>
			<?php }?>
			<?php if($user_gorup_id == 7) {?>
			<span  class="umstyle6"><?php echo $this->Html->link(__('Finishing Manager'), array('plugin' => false,'controller' => 'rolls', 'action' => 'index')); ?> </span><br/><br/>
			<?php }?>
			<?php if($user_gorup_id == 8) {?>
			<span  class="umstyle6"><?php echo $this->Html->link(__('Main Store'), array('plugin' => false,'controller' => 'rolls', 'action' => 'index')); ?> </span>
			<?php }?>
			<div class="umhr"></div>
